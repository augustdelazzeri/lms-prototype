...
export default function GenerateCoursePage() {
  ...
  const handleStartBuilding = () => {
    ...
    if (buildMode === "manual") {
      router.push("/GUARD-1302/admin/courses");
      return;
    }
  ...
  const handleOpenEditor = () => {
    if (createdCourseId) {
      router.push(`/GUARD-1302/admin/courses/${createdCourseId}/edit`);
    }
  };

  const handleContinueWorking = () => {
    router.push("/GUARD-1302/admin/courses?toast=generating");
  };
                      ...
                      <div className="pt-4 border-t border-gray-100">
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          {(!orgSettings.secondaryLanguages || orgSettings.secondaryLanguages.length === 0) && (
                            <Link
                              href="/GUARD-1302/admin/settings/customization"
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-8 text-center">
                ...
                <button
                  onClick={() => {
                    ...
                    router.push(`/GUARD-1302/admin/courses/${newCourse.id}/edit`);
                  }}
