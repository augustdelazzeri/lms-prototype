// Phase I Epic 1, 2, 3 & Polish Pack: Seed data for UpKeep Learn demo
...
export const users: User[] = [
  // Admin (org-wide)
  {
    ...
    role: "ADMIN",
    jobTitleText: "System Administrator",
    active: true,
  },
  // Managers - Site-level
  {
  ...
  // Managers - Department-level
  {
    ...
    role: "MANAGER",
    jobTitleText: "Packaging Supervisor",
    siteId: "site_a",
  ...
  },
  {
    ...
    role: "MANAGER",
    jobTitleText: "Maintenance Supervisor",
    siteId: "site_b",
  ...
  },
  {
    ...
    role: "MANAGER",
    jobTitleText: "Warehouse Supervisor",
    siteId: "site_a",
  ...
  // Learners - Plant A Packaging (6)
  {
    ...
    role: "LEARNER",
    jobTitleId: "jt_prod_line_lead",
    jobTitleText: "Packaging Operator",
    siteId: "site_a",
    departmentId: "dept_a_packaging",
  ...
  },
  {
    ...
    role: "LEARNER",
    jobTitleText: "Quality Inspector",
    siteId: "site_a",
    departmentId: "dept_a_packaging",
    managerId: "usr_mgr_a_pkg",
    active: true,
  ...
  },
  {
    ...
    jobTitleText: "Safety Coordinator",
    siteId: "site_a",
    departmentId: "dept_a_packaging",
    managerId: "usr_mgr_a_pkg",
    active: true,
  ...
  // Learners - Plant A Warehouse (2)
  {
    ...
    role: "LEARNER",
    jobTitleId: "jt_forklift_operator",
    jobTitleText: "Forklift Operator",
    siteId: "site_a",
    departmentId: "dept_a_warehouse",
  ...
  },
  {
    ...
    role: "LEARNER",
    jobTitleText: "Warehouse Associate",
    siteId: "site_a",
    departmentId: "dept_a_warehouse",
    managerId: "usr_mgr_a_wh",
    active: true,
  ...
  // Learners - Plant A Maintenance (1)
  {
    ...
    jobTitleText: "Maintenance Technician",
    siteId: "site_a",
  ...
  },
  {
    ...
    role: "LEARNER",
    jobTitleId: "jt_maint_electrical",
    jobTitleText: "Electrician",
    siteId: "site_b",
    departmentId: "dept_b_maintenance",
    managerId: "usr_mgr_b_maint",
    active: true,
...
export const trainings: Training[] = [
  {
    ...
    skillsGranted: [
      { skillId: "skl_forklift", evidenceRequired: true },
    ],
  ...
  },
  {
    ...
    skillsGranted: [
      { skillId: "skl_gmp", evidenceRequired: false },
    ],
    createdAt: "2024-01-01T00:00:00.000Z",
    updatedAt: "2024-01-01T00:00:00.000Z",
  },
  {
    ...
    skillsGranted: [
      { skillId: "skl_loto", evidenceRequired: true },
      { skillId: "skl_electrical_basic", level: 1, evidenceRequired: false },
    ],
    createdAt: "2024-01-01T00:00:00.000Z",
    updatedAt: "2024-01-01T00:00:00.000Z",
  },
  {
    ...
    skillsGranted: [
      { skillId: "skl_incident_investigation", evidenceRequired: false },
    ],
    createdAt: "2024-01-01T00:00:00.000Z",
    updatedAt: "2024-01-01T00:00:00.000Z",
  },
  // Additional trainings for demo variety
  {
    ...
    skillsGranted: [
      { skillId: "skl_hazmat", evidenceRequired: true },
    ],
  ...
  },
  {
    ...
    skillsGranted: [
      { skillId: "skl_confined_space", evidenceRequired: true },
    ],
  ...
  },
  {
    ...
    skillsGranted: [
      { skillId: "skl_fall_protection", evidenceRequired: true },
    ],
  ...
  },
  {
    ...
    skillsGranted: [
      { skillId: "skl_first_aid", evidenceRequired: true },
    ],
  ...
  },
  {
    ...
    skillsGranted: [
      { skillId: "skl_troubleshooting", evidenceRequired: false },
      { skillId: "skl_preventive", evidenceRequired: false },
    ],
